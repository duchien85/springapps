...
<table class="formTable">
	<tr>
		<td class="form_label"><form:label path="bookName" cssErrorClass="errors" >Name</form:label></td>
		<td class="form_input"><form:input path="bookName" /></td>
	</tr>
	<tr>
...
YAHOO.util.Event.onDOMReady(function(){
	...
	submitButton.set("title", "Save new Book");
	
    cancelButton = new YAHOO.book.Button("cancelButton");

    calButton = new YAHOO.book.Button("showButton");
    calendar = new YAHOO.book.Calendar("cal", {iframe:true, hide_blank_weeks:true });
    ...
    dialog = new YAHOO.book.Dialog("container", {
