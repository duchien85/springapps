...
<form:form modelAttribute="actorModel" method="post">
  ...
  <table>
    <tr>
      <td><form:input path="id" cssClass="displayNone" size="50" /> <form:label path="firstName"
        cssErrorClass="errors">*First Name</form:label></td>
      <td><form:input path="firstName" size="50" /></td>
    </tr>
    <tr>
      <td><form:label path="lastName" cssErrorClass="errors">*Last Name</form:label></td>
