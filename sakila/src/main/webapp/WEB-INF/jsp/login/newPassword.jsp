...
<form:form modelAttribute="webSecurityModel" method="post">
  <table>
    <tr>
      <td><form:label path="password" cssErrorClass="errors">*New Password</form:label></td>
      <td><form:password path="password" size="50" /></td>
    </tr>
    <tr>
      <td><form:label path="confirmPassword" cssErrorClass="errors">*Confirm Password</form:label></td>
      <td><form:password path="confirmPassword" size="50" /></td>
    </tr>
    <tr>
