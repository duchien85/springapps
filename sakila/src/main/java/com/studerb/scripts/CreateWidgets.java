...
import com.studerb.widget.Widget;
import com.studerb.widget.WidgetService;

//Remeber to change the datasource in applicationContext.xml
//before running this script, and also remove the jndi reference
//if not running under Tomcat
