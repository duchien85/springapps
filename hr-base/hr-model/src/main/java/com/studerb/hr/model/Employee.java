 ...
 *         &lt;element name="job_histories" type="{}JobHistoriesType"/>
 *       &lt;/sequence>
...
public class Employee {
    ...
    private SortedSet<JobHistory> jobHistory = new TreeSet<JobHistory>();
    ...
    public SortedSet<JobHistory> getJobHistory() {
        return jobHistory;
    }

    public void setJobHistory(SortedSet<JobHistory> jobHistory) {
    ...
    @XmlElement(name = "job_histories", required = true)
    public JobHistories getJobHistories() {
        JobHistories jh = new JobHistories();
        List<JobHistory> jhAsList = new ArrayList<JobHistory>(getJobHistory());
        jh.jobHistories = jhAsList;
        return jh;
    }

    public void setJobHistories(JobHistories jobHistories) {
        jobHistory = new TreeSet<JobHistory>(jobHistories.getJobHistories());
    }
