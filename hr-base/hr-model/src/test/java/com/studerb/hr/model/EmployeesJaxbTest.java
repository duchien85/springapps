...
public class EmployeesJaxbTest extends AbstractJaxbTest {
    ...
    public void EmployeesToXml() throws Exception {
        ...
        assertTrue(DateUtils.isSameDay(e1.getHireDate(), DatatypeConverter.parseDate(document
                .valueOf("/employees/employee[1]/hire_date"))));
        ...
        assertTrue(StringUtils.isBlank(document.valueOf("/employees/employee[1]/job_histories")));
        ...
        assertTrue(DateUtils.isSameDay(e2.getHireDate(), DatatypeConverter.parseDate(document
                .valueOf("/employees/employee[2]/hire_date"))));
        ...
        assertTrue(StringUtils.isBlank(document.valueOf("/employees/employee[2]/job_histories")));
        ...
        assertTrue(DateUtils.isSameDay(e3.getHireDate(), DatatypeConverter.parseDate(document
                .valueOf("/employees/employee[3]/hire_date"))));
        ...
        assertTrue(StringUtils.isBlank(document.valueOf("/employees/employee[3]/job_histories")));
        ...
        assertTrue(DateUtils.isSameDay(e4.getHireDate(), DatatypeConverter.parseDate(document
                .valueOf("/employees/employee[4]/hire_date"))));
        ...
        assertTrue(StringUtils.isBlank(document.valueOf("/employees/employee[4]/job_histories")));
