...
/**
 * All of the documents have invalid XML chars (low byte control chars).
 * <code>XmlToDomTransformer</code> is explicitly set to <strong>NOT</strong>
 * attempt to clean invalid XML Strings by setting to false its
 * <code>xmlToDomTransformer.setCleanXml(false)</code>.
 * method.
 * @author studerw
 *
 */
public class MessageDbFailsTest extends AbstractUnicodeTest {
    ...
    public void Utf8Fail() throws Exception {
        ...
        fail("Should have thrown RuntimeException due to invalid XML chars");
    }
