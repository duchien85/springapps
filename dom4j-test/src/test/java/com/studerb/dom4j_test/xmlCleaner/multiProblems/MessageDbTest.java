...
public class MessageDbTest extends AbstractUnicodeTest {
    ...
    final static String UTF8 = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf8.xml";
    final static String UTF8_BOM = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf8_bom.xml";
    final static String UTF16BE = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf16be.xml";
    final static String UTF16LE = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf16le.xml";
    final static String UTF16_BEBom = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf16_BEBom.xml";
    final static String UTF16_LEBom = "test-files/xml/messagedb_full/not_well_formed/multi_problems/utf16_LEBom.xml";
