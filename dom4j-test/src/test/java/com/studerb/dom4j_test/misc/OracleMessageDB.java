...
/**
 * Testing connection to MessageDb scheme on Linux 10g instance.
 * @author studerw
 *
 */
public class OracleMessageDB {

    private static final Logger log = Logger.getLogger(OracleMessageDB.class);
    ...
    public static void beforeClass() throws SQLException {
        ...
        ods.setURL("jdbc:oracle:thin:messagedb/messagedb@centos:1521/orcl");
    }
