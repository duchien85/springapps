...
/**
 * <p>
 * Tests the JVM's standard ability to successly import files with Unicode
 * (Chinese multi byte) characters in multiple encodings.
 * </p>
 * <p>
 * Summary - Java can read most encodings of unicode only when the correct
 * encoding is explicity set on converting a file, socket, etc into a String.
 * UTF8 with Boms (i.e. from Windows Notepad) <strong>always</strong> fail
 * unless the imported {@ link UnicodeReader UniocdeReader} is used.
 * </p>
 * <p>
 * Even UnicodeReader chokes when the correct encoding is not
 * explicitly passed to the method converting bytes to characters.
 * However, unicode encoded files containing <strong>BOMS</strong>
 * will work even when the default encoding is passed.
 * </p>
 * @author studerw
 *
 */
public class TenChineseTest extends AbstractUnicodeTest{
    private final static Logger log = Logger.getLogger(TenChineseTest.class);

    final static String UTF8_BOM = "test-files/unicode/ten_chinese/utf8_bom.txt";
    final static String UTF8 = "test-files/unicode/ten_chinese/utf8.txt";
    final static String UTF16LE = "test-files/unicode/ten_chinese/utf16le.txt";
    final static String UTF16BE = "test-files/unicode/ten_chinese/utf16be.txt";
    final static String UTF16LE_BOM = "test-files/unicode/ten_chinese/utf16le_bom.txt";
    final static String UTF16BE_BOM = "test-files/unicode/ten_chinese/utf16be_bom.txt";

    final static int NUM_CHARS = 11;
    public static String ESCAPED  = "\u4f8b\u4fbe\u4fca\u4fd6\u4ff3\u504d\u507a\u517e\u5180\u51f4\n";

    @BeforeClass
    public static void beforeClass() {
        AbstractUnicodeTest.beforeClass();
        log.info("Testing a Ten-Chinese-Character String: " + ESCAPED);
    }
